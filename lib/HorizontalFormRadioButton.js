...
var Option = function (props) {
	var inputProps = {
		type: "radio", name: props.label, defaultValue: props.value,
		checked: (props.value === props.currentValue), onChange: props.onChange
	};
...
var HorizontalFormRadioButton = function (props) {
	var options = props.options.map(function (option) {
		var optionProps = {
			...
			onChange: props.onChange, currentValue: props.value
		};
